...
def model_evaluation(z_train,y_train,z_test,y_test,cl_train,cl_test,n_cluster=10,neighbours=5,device="cpu"):
    ...
    knn_report,knn_df,knn_acc=kNN_evaluation(z_train,y_train,z_test,y_test,neighbours=neighbours)
    print(knn_report)
